                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-10 d-flex">
                            <input class="form-control @if ($error['password'] == true) is-invalid @endif"
                                type="{{ $pass == true ? 'text' : 'password' }}" name="password" id="password" wire:model='password'
                                placeholder="input the password for your new credential" autofocus>
                                <a class="img-input" href="#" wire:click='setPass({{ $pass == true ? 'false' : 'true' }})'>
                                    <img class="img-width"
                                        src="/img/{{ $pass == true ? 'eye-off' : 'eye-on' }}.svg"
                                        alt="See password">
                                </a>
                        </div>
                    </div>
