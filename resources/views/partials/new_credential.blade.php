                ...
                <div class="card-body">
                    ...
                    <div class="m-auto col-md-12 px-3 py-3 rounded justify-content-between">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-10">
                                <input class="form-control @if($error['detail'] === true) is-invalid @endif " type="text" name="detail" id="detail" wire:model='detail'
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-10">
                                <input class="form-control @if($error['username']== true) is-invalid @endif" type="text" name="username" id="username" wire:model='username'
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-10 d-flex">
                                <input class="form-control @if($error['password']== true) is-invalid @endif" type="password" name="password" id="password" wire:model='password'
